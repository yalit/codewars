...
namespace Tests\Kyu5;

use App\Kyu5\PhoneDirectory;
...
class PhoneDirectoryTest extends TestCase
{
    ...
    private function dotest($actual, $expected): void
    {
    ...
    public function testphoneBasics() {
        ...
        $this->dotest($phoneDirectory->phone($this->dr, "48-421-674-8974"), "Phone => 48-421-674-8974, Name => Anastasia, Address => Via Quirinal Roma");
        $this->dotest($phoneDirectory->phone($this->dr, "19-421-674-8974"), "Phone => 19-421-674-8974, Name => C Powel, Address => Chateau des Fosses Strasbourg F-68000");
        $this->dotest($phoneDirectory->phone($this->dr, "1-921-512-2222"), "Phone => 1-921-512-2222, Name => Wilfrid Stevens, Address => Wild Street AA-67209");
        $this->dotest($phoneDirectory->phone($this->dr, "1-908-512-2222"), "Phone => 1-908-512-2222, Name => Peter O'Brien, Address => High Street CC-47209");
        $this->dotest($phoneDirectory->phone($this->dr, "1-541-754-3010"), "Phone => 1-541-754-3010, Name => J Steeve, Address => 156 Alphand St.");
    }
}